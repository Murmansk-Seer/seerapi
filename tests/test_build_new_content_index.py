...
def test_same_week_pool_changes_keep_origin_and_drop_reverts(tmp_path: Path) -> None:
    baseline_path = tmp_path / 'baseline.sqlite'
    previous_path = tmp_path / 'previous.sqlite'
    current_path = tmp_path / 'current.sqlite'
    _create_database(baseline_path, version='20260807100000', pet_ids=(1, 2))
    _create_database(previous_path, version='20260814100000', pet_ids=(1, 2))
    _create_database(current_path, version='20260815100000', pet_ids=(1, 2))
