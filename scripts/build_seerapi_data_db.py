...
EFFECT_ICON_BUILD_CONFIG = EffectIconBuildConfig(
    ...
    composite_render_timeout_seconds=(EFFECT_ICON_PNG_COMPOSITE_RENDER_TIMEOUT_SECONDS),
...
def _release_publication_context() -> ReleasePublicationContext:
    return ReleasePublicationContext(
        ...
        resolve_effect_icons=lambda icon_ids: resolve_effect_icon_png_assets(
            ...
            fetch_package_manifest=lambda base_url, package_name: (
                BUILD_HTTP.fetch_package_manifest(
                    base_url,
                    package_name,
...
def _export_effect_icon_cache(icon_ids: Sequence[int], output_dir: Path) -> int:
